<?php
/**********************************************************************/
/* Bibtech Mediawiki Extension
/*
/**********************************************************************/

// TODO: OO rewrite & exceptions

if( !defined( 'MEDIAWIKI' ) ) die();

//// import functions
require_once( "Bibtech.parser.func.php" );
require_once( "Bibtech.render.func.php" );

//// import classes
// $wgAutoloadClasses['Bibtech'] = dirname(__FILE__) . '/Bibtech.body.php';

//// Register Bibtech extension
$wgExtensionCredits['parserhook'][] = array(
  'path' => __FILE__,
  'name' => 'Bibtech',
  'author' => 'Tom Hornos',
  'url' => 'http://www.mediawiki.org/wiki/Extension:Bibtech',
  'description' => 'A Simple Bibtex Parser',
  'version' => '1.17.0'
);

//// Register i18n
$wgExtensionMessagesFiles['Bibtech'] = dirname( __FILE__ ) . '/Bibtech.i18n.php';
